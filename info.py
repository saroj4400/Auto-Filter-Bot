...
# Bot information
API_ID = environ.get('API_ID', '28057612')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7724633923:AAEXJ0M7ysMEKCfaYkaWyHfgDr5so4BYMdo')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '127658237')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002421033997')
if len(LOG_CHANNEL) == 0:
    print('Error - LOG_CHANNEL is missing, exiting now')
    exit()
else:
    LOG_CHANNEL = int(LOG_CHANNEL)
FORCE_SUB_CHANNELS = [int(fsub_channels) if fsub_channels.startswith("-") else fsub_channels for fsub_channels in environ.get('FORCE_SUB_CHANNELS', 'https://t.me/madyyyyyyyl').split()]
if len(FORCE_SUB_CHANNELS) == 0:
    print('Info - FORCE_SUB_CHANNELS is empty')
    
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', 'https://t.me/+WdVtdTXQ9foyZTM1')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://serexmodapps:ABoEAOChrhbzQO9k@cluster0.wejgznq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
